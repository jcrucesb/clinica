function buscar_ciudad_secretaria(num){
    //
    console.log(num)
    let opcion = "";
    let opcion_comuna = "";
    if (num == 0) {
        ...
        opcion = document.getElementById("secretaria_region").value
        opcion_comuna = document.getElementById("secretaria_comuna")
        if (opcion == 1) {
    ...
    if (num == 1) {
        opcion = document.getElementById("edit_secretaria_region").value
        console.log(opcion)
